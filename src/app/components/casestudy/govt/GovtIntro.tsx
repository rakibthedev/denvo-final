...
const meta = [
  { label: "Industry", value: "Govt. Certificate", bg: "#f3e8ff" },
  { label: "Services", value: "Mobile App Design", bg: "#eefcd6" },
  { label: "Timeline", value: "2 Weeks", bg: "#e5f0ff" },
];

export default function GovtIntro() {
  return (
    <section className="bg-white py-14 md:py-20">
      <div className="mx-auto w-full max-w-[1440px] px-5 md:px-20">
        <div className="flex flex-col items-start gap-10 md:flex-row md:items-center md:gap-16">
          ...
          >
            <Image
              src="/govt-certificate-app/intro-phones.png"
              alt="Prottoyon app preview"
              width={847}
              height={612}
        ...
        {/* Project Impression */}
        <WordReveal
          text="Project Impression"
          className="mt-14 text-[22px] font-bold leading-[120%] text-ink md:mt-20 md:text-[28px]"
        />
